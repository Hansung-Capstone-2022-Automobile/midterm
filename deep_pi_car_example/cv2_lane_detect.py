...
def test_video(video_file):
    ...
    video_overlay = cv2.VideoWriter("%s_overlay.avi" % (video_file), fourcc, fps, (w, h))
    try:
        i = 0
        while cap.isOpened():
            _, frame = cap.read()
            ...
            # 딥러닝 학습을 위한 이미지 데이터셋 생성 (비디오파일이름, i번재, 조향각도)
...
if __name__ == '__main__':
    ...
    test_video("C:/Users/User/Desktop/get_data/data/output2.avi")

    # test_video("C:/Users/User/capstone/line_detection/test.mp4")
